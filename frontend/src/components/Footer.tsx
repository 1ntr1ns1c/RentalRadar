...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300 pt-12 pb-8 mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm">
              Email:{" "}
              <a
                href="mailto:support@rentalradar.com"
                className="hover:text-white"
              >
                support@rentalradar.com
              </a>
            </p>
            ...
            <p className="text-sm mt-4">
              ...
              <a href="https://arcitec.co.ke/" className="hover:text-blue-600">
                Arcitec IT company
              </a>
            </p>
          </div>
